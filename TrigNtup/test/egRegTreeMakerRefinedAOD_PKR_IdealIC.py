...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('egm_reg_DoubleEle_EcalIdealIC_Tree_5files_02022023.root'))
...
outputFile = cms.string('egm_reg_DoubleEle_EcalIdealIC_Tree_5files_02022023.root')
